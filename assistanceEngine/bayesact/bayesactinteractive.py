...
class cBayesactInteractive(object):
    def __init__(self, argv, plotter=None):
        ...
        #identities file
        self.fifname="bayesact/fidentities.dat"
        ...
        while not done:
            ...
            if learn_turn=="agent":
                ...
                if self.useEmotionalAgent:
                    ...
                    print "this is using emotional agent, and it is client's turn, the observed is"
                    print learn_eobserv
                    print clientEmotion
                    print clientEmotionLabel
            ...
            if learn_turn=="client" and learn_observ==[]:
                ...
                if self.useEmotionalAgent:
                	print "learn the observed action"
                	print learn_eobserv
                	print learn_aab
