...
if __name__ == '__main__':
    ...
    sensor_reliability = [0.9, 0.95]
    #sensor_reliability = [3, 9]
    #files = [1, 2, 3]
    #sensor_reliability = [-1, 0.5, -2]
    #for file_num in range(4, 8):
    for file_num in range(14, 15):
        for x in sensor_reliability:
            ...
            if x == None:
                sensor_command = "mongoimport --db smart_home --collection sensor --drop --file ~/Documents/DIYSmartHome/KnowledgeBase/kbexa_uncertain_20170130/sensor.json"
            else:
                sensor_command = "mongoimport --db smart_home --collection sensor --drop --file ~/Documents/DIYSmartHome/KnowledgeBase/kbexa_uncertain_20170130/sensor" + "_" + str(x) + ".json"
                
            os.system(sensor_command)
            #print sensor_command 
            #
            #print file_num
            #print x
