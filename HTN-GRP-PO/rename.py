...
if __name__ == "__main__":
   ...
   # create new add new files
    ...
    #                 if path_i == 0:
    #                     path = "/home/ifrah/DDrive/Research_Projects/ICAPS2023/DGR-POMDP/tian/block/"+ agent_type +"/dp17_sn5_df0.95_e1_wp-5_qr5_qp-5_oh0.76_dt0.001/episode_reward/"
    ...
    #                 else:
    #                     path = "/home/ifrah/DDrive/Research_Projects/ICAPS2023/DGR-POMDP/tian/block/"+ agent_type +"/dp17_sn5_df0.95_e1_wp-5_qr5_qp-5_oh0.76_dt0.001/step_reward/"
